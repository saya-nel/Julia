...
public abstract class FunctionBox extends HBox {
    ...
    protected void initMenu() {
        ...
        // play :
        play = new Button();
        InputStream is = getClass().getResourceAsStream("/view/lib/play-button-1.png");
